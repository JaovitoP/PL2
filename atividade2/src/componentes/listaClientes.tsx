          ...
          <div className="col">
            <div className="input-group mb-3">
              <button
                ...
                type="button"
                style={{ background: tema }}
                onClick={(e) => this.props.seletorView("Buscar Tutor", e)}
              >
          ...
          <div className="col">
            <div className="input-group mb-3">
              <button
                ...
                type="button"
                style={{ background: tema }}
                onClick={(e) => this.props.seletorView("Mais Consumidos", e)}
              >
          ...
          <div className="col">
            <div className="input-group mb-3">
              <button
                ...
                type="button"
                style={{ background: tema }}
                onClick={(e) => this.props.seletorView("Pagamento", e)}
              >
                Ir para Pagamento
              </button>
            </div>
